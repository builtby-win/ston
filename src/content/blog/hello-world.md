...
title: "hello world"
date: 2025-12-31
description: "2026 is going to be my year"
tags: ["coding", "meta"]
---
...
The only problem I've been having is that I'm not marketing at ALL.

Purely coding and building things but not doing anything to share them.
...
My plan for 2026 is to start streaming all of my coding sessions on YouTube/Twitch/Instagram/TikTok, uploading the VODs to YouTube, and figuring out how to do some clip farming.

I tried streaming earlier this year but it was so boring because I was actually writing all the code and building features took so long. But now I'm spending all of my time glued to the screen working on so many projects simultaneously that I think the stream will be very interesting because there will always be something happening.

I've been building lots of little marketing funnels too, like sharing my [dotfiles](https://github.com/builtby-win/dotfiles), [Claude skills](https://github.com/builtby-win/skills) that I've been working on, and [my blog](https://builtby.win/blog).

I've been building so many things, it's so fun and invigorating that I can have an idea and make it come to life within a day or two.
...
[boilerplates](https://buy.polar.sh/polar_cl_roG7nfaMGE2RfMg9LKoPFZCzrz6XGuDxYlhag1f56kM)

I used the web boilerplate to build the entire MVP of [areyougo.ing](https://areyougo.ing) in less than 4 days.

2026 is gonna be poggie woggie. Looking forward to it very much.
